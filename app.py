...
GROQ_API_KEY     = "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"
...
def debug():
    ...
    # Test each sport API
    today = datetime.now(timezone.utc).strftime("%Y-%m-%d")
    nba_test = safe_get(NBA_BASE + "/games", NBA_H, {"date": today})
    mlb_test = safe_get(MLB_BASE + "/games", MLB_H, {"date": today})
    return jsonify({
